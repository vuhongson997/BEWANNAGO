...
class StayController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        */
        ...
        $allUser = User::all();
        $tStayHost = TStay::where('stay_id', $id)->first();
        $address = TAddress::where('stay_id', $id)->first();
        $allAddress = TAddress::all();
        $allWard = M_ward::orderBy('name', 'asc')->get();
        $allDistrict = M_district::orderBy('name', 'asc')->get();
        // $stay = TStay::find($id);
        // $hostForStay = $stay->host()->get();
        
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','allUser','address','allAddress','allWard','allDistrict','tStayHost'));
    }
