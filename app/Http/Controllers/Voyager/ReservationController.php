...
class ReservationController extends VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        $detail = DB::table('t_reservation_detail')->where('reservation_id', $id)->first();
        //Name stay
        $name_stay = DB::table('t_stay')->where('stay_id', $detail->stay_id)->first();
        $name_stay = $name_stay->stay_name;
        ...
        // $dataTypeContent = convertObjectClass(array_merge( 
        //         (array) $dataTypeContent, (array) $detail), 'ReservationController'); 
        ...
        return Voyager::view($view, compact('dataType', 'detail', 'name_stay', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
    //***************************************
    //                ______
    //               |  ____|
