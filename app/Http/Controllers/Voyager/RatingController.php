...
class RatingController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        if(Auth::user()->role_id == "1"){
            ...
            //Get name stay
            foreach($dataTypeContent as $key => $val){
               $name_stay = DB::table('t_stay')->where('stay_id', $val['stay_id'])->first();
                $stay_inf[$val['stay_id']] = $name_stay->stay_name;
            };
    ...
    public function show(Request $request, $id)
    {
        ...
        //Stay Name
        $name_stay = DB::table('t_stay')->where('stay_id', $dataTypeContent->stay_id)->first();
        ...
        return Voyager::view($view, compact('dataType', 'name_stay', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
    //***************************************
    //                ______
    //               |  ____|
